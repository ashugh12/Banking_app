...
function App() {
  ...
  return (
    <div>
      <div className='head-text-center'><h1 className="text-center">Apply for a Home Loan</h1></div>
      <form action="" method="post" className="flex flex-col justify-center items-center gap-5 w-full lg:px-20 my-4">
